...
import { openPopup, closePopup } from '../../redux/slices/loginmodal/loginmodal';
...
function NavbarScroll({ scrolled }: NavbarProps) {
  ...
  useEffect(() => {
    ...
    return (
         <nav className='p-2 bg-gradient-to-b from-white to-gray-100 shadow-sm '>
            
                    <div className=" text-sm md:flex md:items-center md:justify-between md:px-2 md:py-1 w-full max-w-[1800px] mx-auto px-4">
                ...
                {/* md- search bar */}
                  ...
                  <ul className=" flex justify-center space-x-8 mt-1 mb-0 pt-2 pb-0 md-1 md:hidden ">
                    <li>
                      <Link href="/home" passHref>
                      <div className={`flex flex-col items-center space-y-1 text-xs md:flex md:flex-row md:space-x-3 
                      ${pathname === '/home' ? 'border-b-2 border-black font-bold' : ''}`}>  
                        <FcHome className='hidden text-4xl md:text-3xl '/>
                    ...
                    <li>
                      ...
                      <div className={`flex flex-col items-center space-y-1 text-xs md:flex md:flex-row md:space-x-3 
                      ${pathname === '/experiences' ? 'border-b-2 border-black font-bold' : ''}`}>
                        <FcSlrBackSide  className='hidden text-4xl md:text-3xl '/>
                    ...
                    <li>
                      ...
                      <div className={`flex flex-col items-center space-y-1 text-xs md:flex md:flex-row md:space-x-3 
                      ${pathname === '/servicesS' ? 'border-b-2 border-black font-bold' : ''}`}>
                        <FcWorkflow className='hidden text-4xl md:text-3xl '/>
            ...
            <div className="hidden md:flex justify-center ">
              <div className="w-[370px] max-w-screen-md md:ml-[7rem]">
                <div className="font-cereal flex bg-white border border-gray-300 rounded-full shadow-[0_4px_12px_rgba(0,0,0,0.1)] overflow-hidden divide-x divide-gray-300">
                  ...
                  {/* Section 1: Where */}
                  <div className="flex  justify-center font-cereal flex-1 px-1 py-2 cursor-pointer hover:bg-gray-100">
                
                    <p className=" font-cereal text-sm text-gray-900">Anywhere</p>
                  </div>
            
                  {/* Section 2: Check-in */}
                  <div className="  flex  justify-center font-cereal flex-1 px-1 py-2 cursor-pointer hover:bg-gray-100">
                
                    <p className=" font-cereal text-sm text-gray-900">Anytime</p>
                  </div>
            
            
                  {/* Section 4: Who */}
                  <div className=" ml-2 mr-2      font-cereal flex items-center justify-between flex-1 px-1 py-1 cursor-pointer hover:bg-gray-100">
                    <div>
                    ...
                    {/* Search icon */}
                    <div className= "bg-red-500 text-white p-2 rounded-full md:ml-1">
                      <svg
                        viewBox="0 0 32 32"
